...
- **S-GFM (ours)** is the model.
- **Same-type fixed** is an oracle that already knows the true generating parameters.
- **Same-type free** and **Blind baseline** are naive references.
